...
const MergedPlanes = forwardRef<any, { material: THREE.ShaderMaterial; width: number; count: number; height: number }>(
  function MergedPlanes({ material, width, count, height }, ref) {
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const PlaneNoise = forwardRef<any, { material: THREE.ShaderMaterial; width: number; count: number; height: number }>(
  function PlaneNoise(props, ref) {
    return (
      <MergedPlanes
        ref={ref}
